...
const Reviews = () => {
  ...
  const reviews = [
    {
      id: 1,
      icon: (
        <BsPersonCircle style={{ marginRight: 10 }} color="#6262ff" size={40} />
      ),
    ...
    },
    {
      id: 2,
      icon: (
        <BsPersonCircle style={{ marginRight: 10 }} color="#ffa7ff" size={40} />
      ),
      name: "Leslie Lopez",
    ...
    },
    {
      id: 3,
      icon: (
        <BsPersonCircle style={{ marginRight: 10 }} color="#FFD68A" size={40} />
      ),
    ...
    },
    {
      id: 4,
      icon: (
        <BsPersonCircle style={{ marginRight: 10 }} color="#435e66" size={40} />
      ),
  ...
  return (
    <div id="Reviews" className="reviews-container">
      <h2 style={{ color: "#121212" }}>Reviews</h2>
      <p style={{ marginBottom: 20, color: "#212121" }}>
        ...
        {reviews.map((r) => (
          ...
          >
            <div style={{ display: "flex", alignItems: "center" }}>
              {r.icon}
              <h3 style={{ color: "#212121" }}>{r.name}</h3>
            </div>
            <p style={{ color: "#212121" }}>{r.review}</p>
