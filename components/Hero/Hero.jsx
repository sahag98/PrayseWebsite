      ...
      <div className='hero-section'>
        <section className='hero-header'>
          ...
          <p className='hero-desc'>
           Create and manage your prayer list,
          ...
          <div className='getStarted'>
            ...
            >
              <div className='appleDownload'>
                <p style={{ color: 'black', marginRight: 5, fontWeight: 500, fontSize: '1rem' }}>Download</p>
                <AiOutlineApple size={30} color='black' />
              </div>
            </a>
            <a className='downloadLinks' target='_blank' href="https://play.google.com/store/apps/details?id=com.sahag98.prayerListApp&hl=en_US&gl=US">
              <div className='androidDownload'>
                <p style={{ color: 'white', marginRight: 5, fontWeight: 500, fontSize: '1rem' }}>Download</p>
        ...
        <div className='hero-right'>
          ...
          <Image className='hero-img' width={700} height={700} src='/assets/hero-img.png' alt="app screenshot" />
        </div>
      </div >
    </main >
  )
