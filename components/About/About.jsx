    ...
    <main id="About" className="about-container">
        ...
        {about.map((a) => (
          ...
          >
            <Image
              ...
              alt={a.title + "image"}
            />
            <h2 style={{ color: "#212121" }}>{a.title}</h2>
            <p style={{ color: "#212121", lineHeight: 1.5 }}>{a.desc}</p>
          </motion.div>
        ))}
      </section>
      <motion.div
      ...
      >
        <h2 className="about-title">
          Our app offers a user-friendly interface and a range of practical
          features.
        </h2>
        <p className="about-long">
          Whether you're looking to deepen your own prayer life or connect with
          others in your community, our app is a valuable tool for anyone
          seeking to grow in their faith. Start your journey towards a more
          intentional and meaningful prayer life today with our prayer list app.
        </p>
      </motion.div>
    </main>
  );
