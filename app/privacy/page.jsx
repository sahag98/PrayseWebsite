...
const Page = () => {
  return (
    ...
    <span>Last updated: September 28, 2023 </span>
    <br />
    <br />
    <p>
...
We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the Privacy Policy Generator.
    ...
    <h3 style={{marginBottom:5}}>Interpretation</h3>
    <p>
    The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
    </p>
    <br />
    <h3 style={{marginBottom:5}}>Definitions</h3>
    ...
    <ul>
      ...
      <li><b>Application</b> refers to Prayse, the software program provided by the Company.</li>
      <li><b>Company</b> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Prayse.</li>
      <li>
      <b>Country</b> refers to: California, United States
      </li>
      <li>
      <b>Device</b> means any device that can access the Service such as a computer, a cellphone or a digital tablet.</li>
      <li>
    ...
    <h3 style={{marginBottom:5}}>Types of Data Collected</h3>
    <h3 style={{marginBottom:5}}>Personal Data</h3>
    ...
    <br />
    <h3 style={{marginBottom:5}}>Usage Data</h3>
    <p>
...
We may also collect information that Your browser sends whenever You visit our Service or when You access the Service by or through a mobile device.
    ...
    <br />
    <h3 style={{marginBottom:5}}>Use of Your Personal Data</h3>
